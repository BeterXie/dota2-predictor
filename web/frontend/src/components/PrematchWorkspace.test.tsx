...
vi.mock("../api", () => ({
  ...
  fetchPrematchMatchPredictions: vi.fn().mockResolvedValue({ match_id: 0, predictions: [] }),
  fetchPrematchPredictionModels: vi.fn().mockResolvedValue({
    data: [],
    pagination: { page: 1, page_size: 100, total: 0, total_pages: 1 },
  }),
  fetchPrematchPredictions: vi.fn().mockResolvedValue({
    data: [],
