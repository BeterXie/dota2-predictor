...
_PAYLOAD_LABELS = {
    ...
    "strict_mapping_id": "严格映射编号",
    "event_id": "赛事编号",
    "event_name": "赛事名称",
    "teams": "参赛队伍",
    "map_number": "地图局号",
    "trusted_game_time_seconds": "可信比赛时间（秒）",
    "vision_captured_at": "视觉帧采集时间",
    "source_frame_ref": "视觉证据帧",
    "selected_side": "选择方",
    "selected_team": "选择队伍",
    "odds_id": "赔率项编号",
    "market_key": "市场编号",
    "signal_transport_key": "信号传输编号",
    "fill_transport_key": "成交传输编号",
    "signal_price": "信号赔率",
    "fill_price": "成交赔率",
    "model_probability": "模型概率",
    "market_probability": "市场隐含概率",
    "edge": "模型优势",
    "principal_contributions": "主要贡献项",
    "quality": "数据质量",
    "model_version": "模型版本",
    "model_kind": "模型类型",
    "model_hash": "模型哈希",
    ...
    "decision_key": "决策编号",
    "decision_input_ref": "决策输入引用",
    "decision_lineage_status": "决策血缘状态",
    ...
    "result": "结算结果",
    "return_units": "返还单位",
    "profit_loss_units": "盈亏单位",
    "cumulative_shadow_statistics": "累计模拟统计",
    "evidence_ref": "结算依据",
    "settled_at": "结算时间",
    "simulation": "是否为模拟",
